    ...
    public class ManageController : MyBaseController
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.ChangeAccountInfoSuccess ? "Your account information was successfully updated."
                : "";
        ...
        public ActionResult ChangeUserInfo(ChangeUserInfoViewModel model)
        {
            ...
            return RedirectToAction("Index", new { Message = ManageMessageId.ChangeAccountInfoSuccess });
        }
        ...
        //        return View(model);
        //    }
        //    var result = await UserManager.ChangeNameAsync(User.Identity.GetUserId(), model.FirstName, model.LastName);
        //    if (result.Succeeded)
        //}
